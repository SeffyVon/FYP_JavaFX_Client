...
public class Config {
	public static String macAddrString = "";//"10.115.217.178";//"172.20.10.2";//"10.8.40.49"; //"10.115.193.30";
	...
	public static String localAddrString = ""; //sender
	public static String otherAddrString = "";
}
