...
public class MyController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		userImageView.setImage(new Image(user.getBigImageLocString()));
	...
	void setUListView(){
		uStringSet.add("User 1");
	    uStringSet.add("User 2");
	    uStringSet.add("User 3");
	    uStringSet.add("User 4");
	    uStringSet.add("User 5");
	    uStringSet.add("User 6");
